...
//! Provenance inspection payloads (`cambium-inspect-v1`).
//!
...
//!
//! Format evolution is additive-only within `cambium-inspect-v1`, the
...
pub struct InspectionResponse {
    /// Format identifier (`cambium-inspect-v1`).
    pub format: String,
...
/// Runs one inspection scenario and returns its `cambium-inspect-v1`
/// payload as JSON.
///
/// # Errors
///
