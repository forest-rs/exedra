# exedra_edit_web_bridge

Wasm bridge crate that executes deterministic, named Exedra Edit scenarios and
returns step snapshots as JSON for browser demos.

## Inspection payloads (`exedra-ops-inspect-v1`)
...
`exedra-ops-inspect-v1` is additive-only.
