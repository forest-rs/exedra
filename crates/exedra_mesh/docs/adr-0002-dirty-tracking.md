...
faces, vertices, and corners need derived data recomputed. Exedra Edit consumes
...
Both Exedra and Exedra Edit use **`invalidation`** (crates.io, the published
...
`invalidation::InvalidationSet` rather than rolling custom tracking. Exedra Edit'
