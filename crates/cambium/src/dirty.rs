...
//! Cambium runtime cache dirtiness channels.
//!
//! This module tracks Cambium-side cache invalidation. Exedra remains the
...
/// Key granularity for Cambium runtime invalidation.
...
impl CacheDirtySet {
    ...
    /// Maps an Exedra change set into Cambium runtime cache channels.
