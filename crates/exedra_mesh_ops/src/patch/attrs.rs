...
pub struct SourceEdgeAttrs {
    /// Optional source seam tag; absence is preserved in the preparation.
    pub seam: Option<bool>,
    /// Optional source sharpness; absence is preserved in the preparation.
