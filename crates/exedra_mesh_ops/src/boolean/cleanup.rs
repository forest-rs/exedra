...
//! improves them with the kernel's [`exedra_mesh::op::collapse_edge`] and
//! [`exedra_mesh::op::flip_edge`] surgery under explicit, geometry-conservative
//! guards:
//!
...
use exedra_mesh::op::{collapse_edge, flip_edge};
use exedra_mesh::{FaceId, HalfEdgeId, Mesh, VertexId, attr};
