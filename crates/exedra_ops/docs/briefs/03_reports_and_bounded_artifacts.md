...
## Decision
Every Exedra Ops operator produces an `OpReport` with deterministic stats/counters and optional bounded artifacts. Artifacts/diagnostics are bounded and deterministically ordered.
