# Brief: Preview vs commit is first-class in Exedra Ops

## Decision
Exedra Ops treats **preview** and **commit** as distinct, explicit execution modes. Preview may be budgeted/approximate and is discardable; commit is reproducible and defines the authoritative result.
