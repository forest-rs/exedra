...
## Decision
Exedra Ops adopts a curated operator taxonomy and freezes a minimum v0.1 operator set.

The taxonomy is informed by broader mesh-operator ecosystems (Blender/OpenMesh/CGAL/Unreal-style families), but v0.1 remains intentionally small and deterministic. Exedra stays focused on kernel edits/invariants; Exedra Ops is the workflow/operator surface.

This brief is a contract for ticket sequencing and discoverability work. It does not rename APIs by itself.

## Taxonomy (Exedra Ops SDK surface)
...
Primitive/patch construction operators at Exedra Ops layer.
...
- `cam-v9q2` (exedra_ops wind tunnel)
