...
//!
//! Edge sharpness is numeric (`f32`) in Exedra and Exedra Ops:
//! - `0.0` means smooth,
...
//!
//! Exedra exposes derived normals plus authored corner overrides. The Exedra Ops
...
//!
//! ```rust
//! use exedra_ops::{Artifacts, EditOperator, OpContext, OpError, OpReport};
//!
