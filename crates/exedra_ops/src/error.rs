...
//! Structured Exedra Ops operator errors.
...
impl OpError {
    ...
    /// Wraps an Exedra build error into Exedra Ops operator space.
    #[must_use]
    ...
    /// Wraps Exedra validation errors into Exedra Ops operator space.
    #[must_use]
