...
## Decision
Exedra Edit relies on Exedra-provided **built-in attribute keys** for core layers (vertex positions, corner UVs, and later corner normal overrides). Exedra Edit does not invent identity for these layers.
...
- **Exedra Edit keys**: easy to start but leads to drift and ambiguity.
