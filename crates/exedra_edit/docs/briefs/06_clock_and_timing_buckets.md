...
## Decision
Exedra Edit records timings in named buckets using an RAII guard. Timing values are best-effort and not deterministic; bucket naming and presence are stable, and repeated measurements accumulate.
