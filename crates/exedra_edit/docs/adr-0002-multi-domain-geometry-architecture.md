...
layer (`exedra_edit`). The architectural pressure is coming from geometry
...
- `exedra_edit` owns deterministic mesh operations and typed adapters for
...
- current mesh-native Exedra Edit operators remain valid,
