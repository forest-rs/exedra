...
//! apply/preview orchestration. Geometry algorithms belong in `exedra_mesh_ops`;
//! adapters convert their typed results into command reports.
//!
//! Lifecycle:
...
//!
//! Edge sharpness is numeric (`f32`) in Exedra and Exedra Edit:
//! - `0.0` means smooth,
...
//!
//! Exedra exposes derived normals plus authored corner overrides. The Exedra Edit
...
//!
//! ```rust
//! use exedra_edit::{Artifacts, EditOperator, OpContext, OpError, OpReport};
//!
