...
//! Operator Reference (v0.1)
//!
//! Curated reference of the mesh command set.
//!
//! Conventions:
...
//! - `report.name` must match the stable `name()` in this reference
...
//! | Stable Name | Operator | Params | Output | Reporting Notes |
//! | --- | --- | --- | --- | --- |
//! | `uv.planar` | [`UvPlanar`](crate::UvPlanar) | [`UvPlanarParams`](crate::UvPlanarParams) | [`FaceSet`](crate::FaceSet) | Timing bucket: `project`. |
...
//!
//! All reference operators should:
