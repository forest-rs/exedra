...
//! Structured Exedra Edit operator errors.
...
impl OpError {
    ...
    /// Wraps an Exedra build error into Exedra Edit operator space.
    #[must_use]
    ...
    /// Wraps Exedra validation errors into Exedra Edit operator space.
    #[must_use]
