...
//! Exedra Edit runtime cache dirtiness channels.
//!
//! This module tracks Exedra Edit-side cache invalidation. Exedra remains the
...
/// Fixed runtime cache channels for Exedra Edit.
...
/// Key granularity for Exedra Edit runtime invalidation.
...
/// Exedra Edit runtime dirty-tracking set.
///
...
impl CacheDirtySet {
    ...
    /// Maps an Exedra change set into Exedra Edit runtime cache channels.
