...
pub(super) fn resolve_plan_section(
    ...
    Ok(PlanSection {
        ...
        west_arcade_bays: evaluation.exact(&quantities.west_arcade_bays)?,
        east_arcade_bays: evaluation.exact(&quantities.east_arcade_bays)?,
        arcade_end_clearance: evaluation.exact(&quantities.arcade_end_clearance)?,
