...
/// counts may differ. Either it lofts, or it refuses with a typed reason.
...
mod tests {
    ...
    /// a typed refusal: loft sections whose discretizations disagree.
    const KNOWN_HARD_FAILURES: &[&str] = &["loft_between_circles"];
